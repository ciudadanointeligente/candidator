...
class ElectionV2Resource(ModelResource):
    ...
    background_categories = fields.ToManyField('elections.api_v2.BackgroundCategoryV2Resource', 'backgroundcategory_set', null=True)
    personal_data = fields.ToManyField('elections.api_v2.PersonalDataV2Resource', 'personaldata_set', null=True)
...
class BackgroundV2Resource(ModelResource):
    background_category = fields.ToOneField('elections.api_v2.BackgroundCategoryV2Resource','category')
...
class PersonalDataCandidateV2Resource(ModelResource):
    candidate = fields.ToOneField('elections.api_v2.CandidateV2Resource','candidate')
    personal_data = fields.ToOneField('elections.api_v2.PersonalDataV2Resource','personal_data')
...
class BackgroundsCandidateV2Resource(ModelResource):
    background = fields.ToOneField('elections.api_v2.BackgroundV2Resource','background')
...
class CandidateV2Resource(ModelResource):
    ...
    personal_data_candidate = fields.ToManyField('elections.api_v2.PersonalDataCandidateV2Resource','personaldatacandidate_set', null=True)
    backgrounds_candidate = fields.ToManyField('elections.api_v2.BackgroundsCandidateV2Resource','backgroundcandidate_set', null=True)
    answers = fields.ToManyField('elections.api_v2.AnswerV2Resource','answers', null=True)
...
class QuestionV2Resource(ModelResource):
    ...
    information_sources = fields.ToManyField('elections.api_v2.InformationSourceResource', 'informationsource_set', null=True)
...
from elections.views import strip_elements_from_dictionary, medianaranja2
