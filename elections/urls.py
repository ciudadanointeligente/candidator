...
from views import associate_answer_to_candidate, ElectionCreateView, ElectionUpdateView, ElectionDetailView, CandidateDetailView, CandidateCreateView, CategoryCreateView, CategoryUpdateView
...
urlpatterns = patterns('',
    ...
    # Edit Category view
    url(r'^(?P<election_slug>[-\w]+)/(?P<slug>[-\w]+)/update/?$', CategoryUpdateView.as_view(), name='category_update'),
