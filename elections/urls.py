...
urlpatterns = patterns('',
    ...
    # Media Naranja
    url(r'^(?P<username>[a-zA-Z0-9-]+)/(?P<election_slug>[a-zA-Z0-9-]+)/medianaranja/embeded/?$', 'elections.views.medianaranja1_embed',name='medianaranja1_embeded'),
    ...
    url(r'^(?P<username>[-\w]+)/(?P<slug>[-\w]+)/compare-async/(?P<candidate_slug>[-\w]+)/?$', 'elections.views.election_compare_asynchronous_call', name='election_compare_asynchronous_call'),
    ...
    # Create Link Ajax
    url(r'^(?P<candidate_pk>\d+)/create_link', 'elections.views.async_create_link', name='link_create_ajax'),
    ...
    # Media Naranja
    url(r'^(?P<username>[a-zA-Z0-9-]+)/(?P<election_slug>[a-zA-Z0-9-]+)/medianaranja$', 'elections.views.medianaranja1',name='medianaranja1'),
    ...
    url(r'^(?P<username>[a-zA-Z0-9-]+)/(?P<election_slug>[a-zA-Z0-9-]+)/candidate_list.json/?$', 'elections.views.candidate_views.get_candidate_list_as_json', name='candidate_list_json'),

    # Delete candidate view in wizzard
    url(r'^candidate/async_delete/?$', 'elections.views.async_delete_candidate' , name='async_delete_candidate'),
    ...
    url(r'^(?P<election_pk>[-\w]+)/personal_data/async_create/?$', 'elections.views.async_create_personal_data', name='async_create_personal_data'),

    # Delete personalData view in wizzard
    url(r'^(?P<personal_data_pk>[-\d]+)/personal_data/async_delete/?$', 'elections.views.async_delete_personal_data', name='async_delete_personal_data'),

    # Create PersonalDataCandidate
    url(r'^(?P<candidate_pk>[0-9]+)/(?P<personal_data_pk>[0-9]+)/personal_data_associate' , 'elections.views.personal_data_candidate_create', name='personal_data_candidate_create'),
    ...
    url(r'^(?P<election_pk>[-\w]+)/background_category/async_create/?$', 'elections.views.async_create_background_category', name='async_create_background_category'),

     # Delete BackgroundCategory view in wizzard
    url(r'^(?P<category_pk>[-\d]+)/background_category/async_delete/?$', 'elections.views.async_delete_background_category' , name='async_delete_background_category'),
    ...
    url(r'^(?P<background_category_pk>[0-9]+)/background/async_create/?$', 'elections.views.async_create_background', name='async_create_background'),

    # Delete background view in wizzard
    url(r'^(?P<background_pk>[-\d]+)/background/async_delete/?$', 'elections.views.async_delete_background' , name='async_delete_background'),

    # Create Category Ajax
    url(r'^(?P<election_pk>[-\w]+)/category/async_create/?$', 'elections.views.async_create_category', name='async_create_category'),

    # Delete category view in wizzard
    url(r'^(?P<category_pk>[0-9]+)/category/async_delete/?$', 'elections.views.async_delete_category' , name='async_delete_category'),
    ...
    url(r'^(?P<question_pk>[0-9]+)/question/async_delete/?$', 'elections.views.async_delete_question' , name='async_delete_question'),

    # Create question view in wizzard
    url(r'^(?P<category_pk>[0-9]+)/question/async_create/?$', 'elections.views.async_create_question' , name='async_create_question'),

    # Delete link ajax
    url(r'^(?P<link_pk>[-\d]+)/link/async_delete/?$', 'elections.views.async_delete_link' , name='async_delete_link'),
